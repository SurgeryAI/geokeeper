...
final class TrackedLocation: Identifiable {
    ...
    // ADDED: Tracks the time user entered the geofence (nil if currently outside)
    var entryTime: Date?
    
    // FIX: Provide a default value for 'iconName' to allow automatic migration
    // of existing saved locations that don't have this field yet.
    var iconName: String = "mappin.circle.fill"

    // ADDED: Computed property to provide the Core Location region object
